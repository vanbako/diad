...
START:
    ...
    ADD     R6, R1          ; R1 was 0xFFFFFF -> test carry        ; 0000 0011 0001 0110 0000 0000 ; 031600 ; tick 22
    ADD     R0, R2          ; 0 + 0x7FF -> normal                  ; 0000 0011 0010 0000 0000 0000 ; 032000

    LUI     #0x000          ; load zero into IR                    ; 0100 0000 0000 0000 0000 0000 ; 400000

    ; --- ADDi unsigned immediate ---
    ADDi    #1,  R2         ; add small value                      ; 0010 0011 0010 0000 0000 0001 ; 232001 ; tick 25
    MOVis   #-1, R1         ; sign extended -1 -> 0xFFFFFF         ; 0011 0010 0001 1111 1111 1111 ; 321fff
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    ADDi    #1,  R1         ; add 1 to 0xFFFFFF -> wrap/carry      ; 0010 0011 0001 0000 0000 0001 ; 231001 ; tick 30
    ...
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    ADDs    R7,  R6         ; signed add -1 + 1 -> 0               ; 0001 0011 0110 0111 0000 0000 ; 136700 ; tick 35
    MOVis   #0x400, R8      ; 0x400 (1024)                         ; 0011 0010 1000 0100 0000 0000 ; 328400
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    ADDs    R8,  R8         ; overflow positive + positive         ; 0001 0011 1000 1000 0000 0000 ; 138800 ; tick 40
    ...
    SUB     R1,  R0         ; 0 - 0xFFFFFF -> underflow            ; 0000 0100 0000 0001 0000 0000 ; 040100 ; tick 46

    ; --- SUBi unsigned immediate ---
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    SUBi    #1,  R2         ; subtract small value                 ; 0010 0100 0010 0000 0000 0001 ; 242001
    SUBi    #1,  R0         ; subtract from underflowed value      ; 0010 0100 0000 0000 0000 0001 ; 240001 ; tick 50
    ...
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    SUBs    R6,  R9         ; -2 - 1 -> -3                         ; 0001 0100 1001 0110 0000 0000 ; 149600 ; tick 55
    MOVis   #1,   R10       ; 1                                    ; 0011 0010 1010 0000 0000 0001 ; 32a001
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    SUBs    R7,  R10        ; 1 - (-1) -> 2                        ; 0001 0100 1010 0111 0000 0000 ; 14a700 ; tick 60

    ; --- SUBis signed immediate ---
    SUBis   #-1, R7         ; -1 - (-1) -> 0                       ; 0011 0100 0111 1111 1111 1111 ; 347fff
    SUBis   #0x800, R8      ; overflow with min negative immediate ; 0011 0100 1000 1000 0000 0000 ; 348800 ; tick 62
    ...
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    AND     R12, R3         ; -1 & 0 -> 0                          ; 0000 0110 0011 1100 0000 0000 ; 063c00 ; tick 74
