...
START:
    ...
    LUI     #0x000          ; load zero into IR                    ; 0100 0000 0000 0000 0000 0000 ; 400000 ; tick        4
    ...
    MOVi    #0xFFF, R1      ; MOVi with max value -> R1 = 0xFFFFFF ; 0010 0010 0001 1111 1111 1111 ; 221fff ; tick  11
    ...
    MOV     R3, R5          ; move negative value                  ; 0000 0010 0101 0011 0000 0000 ; 025300 ; tick  17
    ...
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    SUB     R6,  R2         ; 0x7FF - 1 -> normal                  ; 0000 0100 0010 0110 0000 0000 ; 042600 ; tick  45   41
    SUB     R1,  R0         ; 0 - 0xFFFFFF -> underflow            ; 0000 0100 0000 0001 0000 0000 ; 040100 ; tick  46   42

    ; --- SUBi unsigned immediate ---
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    SUBi    #1,  R2         ; subtract small value                 ; 0010 0100 0010 0000 0000 0001 ; 242001
    SUBi    #1,  R0         ; subtract from underflowed value      ; 0010 0100 0000 0000 0000 0001 ; 240001 ; tick  50   46
    ...
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    AND     R11, R2         ; 0x7FE & 0xF0                         ; 0000 0110 0010 1011 0000 0000 ; 062b00 ; tick  69   65
    MOVis   #0,    R12      ; zero                                 ; 0011 0010 1100 0000 0000 0000 ; 32c000 ; tick  70
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    AND     R12, R3         ; -1 & 0 -> 0                          ; 0000 0110 0011 1100 0000 0000 ; 063c00 ; tick  74   70
    ...
    ; --- OR ---
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    OR      R11, R3         ; -1 OR 0xF0 -> -1                     ; 0000 0111 0011 1011 0000 0000 ; 073b00 ; tick  78   74
    ...
    ORi     #0,    R6       ; no change                            ; 0010 0111 0110 0000 0000 0000 ; 276000 ; tick  81   77

    ; --- XOR ---
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    XOR     R11, R4         ; mix values                           ; 0000 1000 0100 1011 0000 0000 ; 084b00
    XOR     R12, R5         ; value XOR 0 -> same                  ; 0000 1000 0101 1100 0000 0000 ; 085c00 ; tick  84   80

    ; --- XORi ---
    XORi    #0xFF, R1       ; toggle low byte                      ; 0010 1000 0001 0000 ffff ffff ; 2810ff
    XORi    #0,    R2       ; unchanged                            ; 0010 1000 0010 0000 0000 0000 ; 282000 ; tick  86   82
    ...
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    SHL     R13, R4         ; simple shift                         ; 0000 1001 0100 1101 0000 0000 ; 094d00 ; tick  91   87
    MOVis   #0x20, R14      ; 32 >= width -> overflow              ; 0011 0010 1110 0000 0010 0000 ; 32e020
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    SHL     R14, R5         ; result zero, V flag                  ; 0000 1001 0101 1110 0000 0000 ; 095e00 ; tick  96   92

    ; --- SHLi ---
    SHLi    #4,  R6         ; left by 4                            ; 0010 1001 0110 0000 0000 0100 ; 296004
    SHLi    #0x20, R7       ; left by 32 -> zero                   ; 0010 1001 0111 0000 0010 0000 ; 297020 ; tick  98   94
    ...
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    SHR     R15, R4         ; right shift                          ; 0000 1010 0100 1111 0000 0000 ; 0a4f00 ; tick 103   99
    MOVis   #0x20, R0       ; >= width                             ; 0011 0010 0000 0000 0010 0000 ; 320020
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    NOP                     ; no operation                         ; 0000 0000 0000 0000 0000 0000 ; 000000
    SHR     R0,  R5         ; result zero                          ; 0000 1010 0101 0000 0000 0000 ; 0a5000 ; tick 108  104

    ; --- SHRi ---
    SHRi    #4,  R6         ; right by 4                           ; 0010 1010 0110 0000 0000 0100 ; 2a6004
    SHRi    #0x20, R7       ; right by 32 -> zero                  ; 0010 1010 0111 0000 0010 0000 ; 2a7020 ; tick 110  106
    ...
    CMPi    #0,    R2       ; compare zero                         ; 0010 1011 0010 0000 0000 0000 ; 2b2000 ; tick 126  122
